...
class m_order extends database
{
    ...
    public function getOrder() {
        $sql = "select orders.id, name_customer, order_date, address, phone_number, orders.total, id_order, sum(order_detail.quantity) as 'total_quantity' FROM orders join customer on orders.id_customer = customer.id join order_detail on orders.id = order_detail.id_order GROUP by id_order"; 
        $this ->setQuery($sql);
        // lấy dữ liệu 
